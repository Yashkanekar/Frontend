...
/*
 Whenever a function is executed, a new execution context is created along with its variable environments (includes the variables defined inside the function) and also the variables it has access to according to its lexical (where the function is written) scope, in this case "first" function is written in the global scope, so that defined what variables access the function will have
